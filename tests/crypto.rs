use antelope_rs::chain::private_key::{KeyType, PrivateKey};

#[test]
fn private_key_encoding() {
    let key = PrivateKey::from("5KQvfsPJ9YvGuVbLRLXVWPNubed6FWvV8yax6cNSJEzB4co3zFu");
    assert!(matches!(key.key_type, KeyType::K1));
    assert_eq!(key.to_wif().unwrap(), String::from("5KQvfsPJ9YvGuVbLRLXVWPNubed6FWvV8yax6cNSJEzB4co3zFu"));
    /*
